...
export function generateWarehouses(): Warehouse[] {
  return [
    { id: 'wh1', name: '广州白云仓', address: '广州市白云区石井镇' },
    { id: 'wh2', name: '广州番禺仓', address: '广州市番禺区大石镇' },
    { id: 'wh3', name: '佛山南海仓', address: '佛山市南海区里水镇' },
  ];
}
...
export function generateFullBusinessState() {
  ...
  const inventoryFlows: InventoryFlow[] = [
    { id: 'if001', date: '2025-01-20', type: '生产入库', product: '直筒牛仔裤', styleNo: 'HJ-001', color: '深蓝', size: 'M', warehouse: '广州白云仓', quantity: 500, beforeStock: 0, afterStock: 500, relatedDoc: 'PB-2025-001', notes: '' },
    { id: 'if002', date: '2025-01-20', type: '生产入库', product: '直筒牛仔裤', styleNo: 'HJ-001', color: '深蓝', size: 'L', warehouse: '广州白云仓', quantity: 500, beforeStock: 0, afterStock: 500, relatedDoc: 'PB-2025-002', notes: '' },
    { id: 'if003', date: '2025-01-25', type: '生产入库', product: 'A字连衣裙', styleNo: 'HW-001', color: '红色', size: 'M', warehouse: '广州番禺仓', quantity: 300, beforeStock: 0, afterStock: 300, relatedDoc: 'PB-2025-003', notes: '' },
    { id: 'if004', date: '2025-02-10', type: '生产入库', product: '基础圆领T恤', styleNo: 'HT-001', color: '白色', size: 'L', warehouse: '广州白云仓', quantity: 1000, beforeStock: 0, afterStock: 1000, relatedDoc: 'PB-2025-004', notes: '' },
    { id: 'if005', date: '2025-02-15', type: '生产入库', product: 'V领T恤', styleNo: 'HT-003', color: '白色', size: 'M', warehouse: '广州白云仓', quantity: 800, beforeStock: 0, afterStock: 800, relatedDoc: 'PB-2025-007', notes: '' },
    { id: 'if006', date: '2025-03-01', type: '生产入库', product: '针织连衣裙', styleNo: 'HW-005', color: '酒红', size: 'M', warehouse: '广州番禺仓', quantity: 300, beforeStock: 0, afterStock: 300, relatedDoc: 'PB-2025-010', notes: '' },
    { id: 'if007', date: '2025-02-01', type: '生产入库', product: 'A字半裙', styleNo: 'HL-001', color: '黑色', size: 'M', warehouse: '广州番禺仓', quantity: 400, beforeStock: 0, afterStock: 400, relatedDoc: 'PB-2025-012', notes: '' },
  ];

  // Generate orders
  const orders: Order[] = [
    { id: 'o001', orderNo: 'SO-2025-001', customerId: 'c001', customerName: 'AfriFashion Ltd', country: 'Nigeria', orderDate: '2025-07-10', totalAmount: 28560, paidAmount: 20000, unpaidAmount: 8560, totalQuantity: 300, shippedQuantity: 150, pendingShipQuantity: 150, status: '部分发货', presaveDeduction: 0, finalReceivable: 8560, items: [{ id: 'oi001', productId: 'p001', styleNo: 'HJ-001', productName: '直筒牛仔裤', color: '深蓝', size: 'M', warehouseId: 'wh1', warehouseName: '广州白云仓', availableStock: 300, quantity: 200, shippedQuantity: 100, unitPrice: 85, subtotal: 17000 }, { id: 'oi002', productId: 'p011', styleNo: 'HT-001', productName: '基础圆领T恤', color: '白色', size: 'L', warehouseId: 'wh1', warehouseName: '广州白云仓', availableStock: 700, quantity: 100, shippedQuantity: 50, unitPrice: 45, subtotal: 4500 }], notes: '' },
    { id: 'o002', orderNo: 'SO-2025-002', customerId: 'c002', customerName: 'Ghana Styles Co', country: 'Ghana', orderDate: '2025-07-12', totalAmount: 19840, paidAmount: 13000, unpaidAmount: 6840, totalQuantity: 180, shippedQuantity: 100, pendingShipQuantity: 80, status: '部分发货', presaveDeduction: 0, finalReceivable: 6840, items: [{ id: 'oi003', productId: 'p006', styleNo: 'HW-001', productName: 'A字连衣裙', color: '红色', size: 'M', warehouseId: 'wh2', warehouseName: '广州番禺仓', availableStock: 220, quantity: 100, shippedQuantity: 60, unitPrice: 120, subtotal: 12000 }, { id: 'oi004', productId: 'p017', styleNo: 'HL-001', productName: 'A字半裙', color: '黑色', size: 'M', warehouseId: 'wh2', warehouseName: '广州番禺仓', availableStock: 300, quantity: 80, shippedQuantity: 40, unitPrice: 68, subtotal: 5440 }], notes: '' },
    { id: 'o003', orderNo: 'SO-2025-003', customerId: 'c005', customerName: 'Uganda Wholesale', country: 'Uganda', orderDate: '2025-07-15', totalAmount: 24560, paidAmount: 17000, unpaidAmount: 7560, totalQuantity: 260, shippedQuantity: 130, pendingShipQuantity: 130, status: '部分发货', presaveDeduction: 0, finalReceivable: 7560, items: [{ id: 'oi005', productId: 'p011', styleNo: 'HT-001', productName: '基础圆领T恤', color: '黑色', size: 'M', warehouseId: 'wh1', warehouseName: '广州白云仓', availableStock: 400, quantity: 200, shippedQuantity: 100, unitPrice: 45, subtotal: 9000 }, { id: 'oi006', productId: 'p022', styleNo: 'HK-001', productName: '休闲卫衣', color: '灰色', size: 'L', warehouseId: 'wh1', warehouseName: '广州白云仓', availableStock: 280, quantity: 60, shippedQuantity: 30, unitPrice: 88, subtotal: 5280 }], notes: '' },
    { id: 'o004', orderNo: 'SO-2025-004', customerId: 'c008', customerName: 'Cape Town Clothing', country: 'South Africa', orderDate: '2025-07-20', totalAmount: 42500, paidAmount: 57500, unpaidAmount: 0, totalQuantity: 250, shippedQuantity: 250, pendingShipQuantity: 0, status: '已完成', presaveDeduction: 35000, finalReceivable: 0, items: [{ id: 'oi007', productId: 'p006', styleNo: 'HW-001', productName: 'A字连衣裙', color: '蓝色', size: 'M', warehouseId: 'wh2', warehouseName: '广州番禺仓', availableStock: 140, quantity: 100, shippedQuantity: 100, unitPrice: 120, subtotal: 12000 }, { id: 'oi008', productId: 'p026', styleNo: 'HQ-001', productName: '风衣外套', color: '卡其', size: 'L', warehouseId: 'wh3', warehouseName: '佛山南海仓', availableStock: 180, quantity: 150, shippedQuantity: 150, unitPrice: 168, subtotal: 25200 }], notes: '' },
    { id: 'o005', orderNo: 'SO-2025-005', customerId: 'c013', customerName: 'Mombasa Traders', country: 'Kenya', orderDate: '2025-07-22', totalAmount: 26780, paidAmount: 18000, unpaidAmount: 8780, totalQuantity: 380, shippedQuantity: 140, pendingShipQuantity: 240, status: '部分发货', presaveDeduction: 0, finalReceivable: 8780, items: [{ id: 'oi009', productId: 'p011', styleNo: 'HT-001', productName: '基础圆领T恤', color: '白色', size: 'L', warehouseId: 'wh1', warehouseName: '广州白云仓', availableStock: 700, quantity: 200, shippedQuantity: 80, unitPrice: 45, subtotal: 9000 }, { id: 'oi010', productId: 'p014', styleNo: 'HT-004', productName: '长袖T恤', color: '白色', size: 'L', warehouseId: 'wh1', warehouseName: '广州白云仓', availableStock: 450, quantity: 180, shippedQuantity: 60, unitPrice: 55, subtotal: 9900 }], notes: '' },
  ];
